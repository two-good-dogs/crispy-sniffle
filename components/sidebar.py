...
def render_sidebar(unread_count: int = 0, platforms: dict = None, audits_df: pd.DataFrame = None):
    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            'section[data-testid="stSidebar"] [data-testid="stPillsButton"] p,'
            'section[data-testid="stSidebar"] [data-testid="stPillsButton"] span,'
            'section[data-testid="stSidebar"] [data-testid="stPillsButton"],'
            'section[data-testid="stSidebar"] button[kind="pillsButton"] p,'
            'section[data-testid="stSidebar"] button[kind="pillsButton"] span,'
            'section[data-testid="stSidebar"] button[kind="pillsButton"]{'
            'color:#ffffff!important;}'
            'section[data-testid="stSidebar"] [data-testid="stPillsButton"][aria-pressed="true"],'
            'section[data-testid="stSidebar"] [data-testid="stPillsButton"][aria-pressed="true"] span,'
            'section[data-testid="stSidebar"] [data-testid="stPillsButton"][aria-pressed="true"] p,'
            'section[data-testid="stSidebar"] button[kind="pillsButton"][aria-pressed="true"],'
            'section[data-testid="stSidebar"] button[kind="pillsButton"][aria-pressed="true"] span{'
